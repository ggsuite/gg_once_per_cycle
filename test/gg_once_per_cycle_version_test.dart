...
void main() {
  group('gg_once_per_cycle_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_once_per_cycle_version.dart');
